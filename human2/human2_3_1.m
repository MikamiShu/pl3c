...
dataFileName = ['data2', subject, '.txt'];
...
stim1 = Screen('MakeTexture', MainWindow, imread('star.png'));
stim2 = Screen('MakeTexture', MainWindow, imread('syuri.png'));
...
%Screen('FrameOval', stim1, black, ovalRect, stroke); % 円を描画
%Screen('FrameOval', stim2, black, ovalRect, stroke); % 円を描画
